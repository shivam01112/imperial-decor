...
$(function () {
    ...
    wind.on("scroll", function () {
        ...
        if (bodyScroll > 100) {
            ...
            logo.attr('src', 'images/Imperia-Decor-Logo.png');
        }
        else {
    ...
    // Enable Bootstrap 5 multi-level dropdowns
    $(document).on('click', '.dropdown-submenu > .dropdown-toggle', function (e) {
        ...
        $parentDropdown.find('> .dropdown-toggle').on('hide.bs.dropdown', function (e) {
            if($submenu.hasClass('show')) {
                e.preventDefault();
            }
        });
        
        // Close submenu when parent dropdown is hidden
        $parentDropdown.on('hidden.bs.dropdown', function () {
